...
HD_PWD='C:/cosas/eseca_M2/SoC/SoC_project/FIR_filter_reloadable/FIR_filter_reloadable/FIR_filter_reloadable.runs/design_1_coef_bank_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_coef_bank_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_coef_bank_0_0.tcl
