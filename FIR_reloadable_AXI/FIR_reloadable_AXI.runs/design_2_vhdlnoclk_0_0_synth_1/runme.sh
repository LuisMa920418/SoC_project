...
HD_PWD='C:/cosas/eseca_M2/SoC/SoC_project/FIR_filter_reloadable/FIR_reloadable_AXI/FIR_reloadable_AXI.runs/design_2_vhdlnoclk_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_2_vhdlnoclk_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_2_vhdlnoclk_0_0.tcl
