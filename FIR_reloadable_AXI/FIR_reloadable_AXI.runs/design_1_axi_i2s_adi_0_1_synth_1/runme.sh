...
HD_PWD='C:/cosas/eseca_M2/SoC/SoC_project/FIR_filter_reloadable/FIR_reloadable_AXI/FIR_reloadable_AXI.runs/design_1_axi_i2s_adi_0_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_axi_i2s_adi_0_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_axi_i2s_adi_0_1.tcl
