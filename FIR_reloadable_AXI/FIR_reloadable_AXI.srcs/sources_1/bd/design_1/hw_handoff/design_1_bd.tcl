...
# module references:
# FIR_reloadable_v1_0, FIR_reloadable_v1_0
...
proc create_root_design { parentCell } {
  ...
  # Create instance: FIR_reloadable_v1_0_0, and set properties
  set block_name FIR_reloadable_v1_0
  set block_cell_name FIR_reloadable_v1_0_0
  if { [catch {set FIR_reloadable_v1_0_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_msg_id "BD_TCL-105" "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $FIR_reloadable_v1_0_0 eq "" } {
     catch {common::send_msg_id "BD_TCL-106" "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   }
    set_property -dict [ list \
   CONFIG.coef_width {18} \
   CONFIG.log2_nbr_coef {6} \
   CONFIG.nbr_coef {40} \
   CONFIG.sig_width {25} \
 ] $FIR_reloadable_v1_0_0

  # Create instance: FIR_reloadable_v1_0_1, and set properties
  set block_name FIR_reloadable_v1_0
  set block_cell_name FIR_reloadable_v1_0_1
  if { [catch {set FIR_reloadable_v1_0_1 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_msg_id "BD_TCL-105" "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $FIR_reloadable_v1_0_1 eq "" } {
     catch {common::send_msg_id "BD_TCL-106" "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   }
    set_property -dict [ list \
  ...
  set_property -dict [ list \
   ...
   CONFIG.PCW_ACT_FPGA1_PERIPHERAL_FREQMHZ {11.290323} \
   ...
   CONFIG.PCW_FCLK1_PERIPHERAL_DIVISOR0 {31} \
   ...
   CONFIG.PCW_FPGA1_PERIPHERAL_FREQMHZ {11.2896} \
  ...
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M02_AXI [get_bd_intf_pins axi_i2s_adi_0/S_AXI] [get_bd_intf_pins ps7_0_axi_periph/M02_AXI]
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M03_AXI [get_bd_intf_pins FIR_reloadable_v1_0_0/s00_axi] [get_bd_intf_pins ps7_0_axi_periph/M03_AXI]
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M04_AXI [get_bd_intf_pins FIR_reloadable_v1_0_1/s00_axi] [get_bd_intf_pins ps7_0_axi_periph/M04_AXI]

  # Create port connections
  connect_bd_net -net AC_RECDAT_1 [get_bd_ports AC_RECDAT] [get_bd_pins axi_i2s_adi_0/SDATA_I]
  ...
  connect_bd_net -net axi_i2s_adi_0_MUTEN_O [get_bd_ports AC_MUTEN] [get_bd_pins axi_i2s_adi_0/MUTEN_O]
  connect_bd_net -net axi_i2s_adi_0_SDATA_O [get_bd_ports AC_PBDAT] [get_bd_pins axi_i2s_adi_0/SDATA_O]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins FIR_reloadable_v1_0_0/s00_axi_aclk] [get_bd_pins FIR_reloadable_v1_0_1/s00_axi_aclk] [get_bd_pins axi_gpio_0/s_axi_aclk] [get_bd_pins axi_gpio_1/s_axi_aclk] [get_bd_pins axi_i2s_adi_0/DMA_REQ_RX_ACLK] [get_bd_pins axi_i2s_adi_0/DMA_REQ_TX_ACLK] [get_bd_pins axi_i2s_adi_0/S_AXI_ACLK] [get_bd_pins processing_system7_0/DMA0_ACLK] [get_bd_pins processing_system7_0/DMA1_ACLK] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins ps7_0_axi_periph/ACLK] [get_bd_pins ps7_0_axi_periph/M00_ACLK] [get_bd_pins ps7_0_axi_periph/M01_ACLK] [get_bd_pins ps7_0_axi_periph/M02_ACLK] [get_bd_pins ps7_0_axi_periph/M03_ACLK] [get_bd_pins ps7_0_axi_periph/M04_ACLK] [get_bd_pins ps7_0_axi_periph/S00_ACLK] [get_bd_pins rst_ps7_0_50M/slowest_sync_clk]
  connect_bd_net -net processing_system7_0_FCLK_CLK1 [get_bd_ports AC_MCLK] [get_bd_pins axi_i2s_adi_0/DATA_CLK_I] [get_bd_pins processing_system7_0/FCLK_CLK1]
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins axi_i2s_adi_0/DMA_REQ_RX_RSTN] [get_bd_pins axi_i2s_adi_0/DMA_REQ_TX_RSTN] [get_bd_pins processing_system7_0/FCLK_RESET0_N] [get_bd_pins rst_ps7_0_50M/ext_reset_in]
  connect_bd_net -net rst_ps7_0_50M_interconnect_aresetn [get_bd_pins ps7_0_axi_periph/ARESETN] [get_bd_pins rst_ps7_0_50M/interconnect_aresetn]
  connect_bd_net -net rst_ps7_0_50M_peripheral_aresetn [get_bd_pins FIR_reloadable_v1_0_0/s00_axi_aresetn] [get_bd_pins FIR_reloadable_v1_0_1/s00_axi_aresetn] [get_bd_pins axi_gpio_0/s_axi_aresetn] [get_bd_pins axi_gpio_1/s_axi_aresetn] [get_bd_pins axi_i2s_adi_0/S_AXI_ARESETN] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/M01_ARESETN] [get_bd_pins ps7_0_axi_periph/M02_ARESETN] [get_bd_pins ps7_0_axi_periph/M03_ARESETN] [get_bd_pins ps7_0_axi_periph/M04_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins rst_ps7_0_50M/peripheral_aresetn]

  # Create address segments
  create_bd_addr_seg -range 0x00010000 -offset 0x43C00000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs FIR_reloadable_v1_0_0/s00_axi/reg0] SEG_FIR_reloadable_v1_0_0_reg0
  create_bd_addr_seg -range 0x00010000 -offset 0x43C10000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs FIR_reloadable_v1_0_1/s00_axi/reg0] SEG_FIR_reloadable_v1_0_1_reg0
