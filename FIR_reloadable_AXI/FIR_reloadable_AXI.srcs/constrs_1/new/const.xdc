...
#set_property -dict { PACKAGE_PIN J15   IOSTANDARD LVCMOS33 } [get_ports { jf[2] }]; #IO_25_35 Sch=jf[3]                          
#set_property -dict { PACKAGE_PIN H15   IOSTANDARD LVCMOS33 } [get_ports { jf[3] }]; #IO_L19P_T3_35 Sch=jf[4]  
